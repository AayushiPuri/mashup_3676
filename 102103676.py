...
def main():
    st.title("Music Mashup Generator - Aayushi Puri - 102103676")
    ...
    if st.button("Generate Mashup"):
        output_filename = "102103676_output.mp3"
        if create_music_mashup('AIzaSyAzrMmAAgGJygxEkBI96aGVLTekpB_LkcY', artist_name, num_videos, audio_duration, output_filename):
            ...
            st.success("Please do check in your spam folder. It will be from mail id : noreply.meaayushipuri@gmail.com")
        else:
